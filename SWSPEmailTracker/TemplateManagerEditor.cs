...
{
    public partial class TemplateManagerEditor : RadRibbonForm
    {
        ...
        public TemplateManagerEditor()
        {
            Initialize();
        }
       
        public TemplateManagerEditor(bool singleInstance)
        {
        ...
        private void Initialize()
        {
            ...
            RadDocument document = docxProvider.Import(Resources.RichTextBox_for_WinForms_Beta);
        ...
        private void radBtnInsertPicture_Click(object sender, EventArgs e)
        {
            using (OpenFileDialog openDialog = new OpenFileDialog())
            {
                ...
                if (openDialog.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    this.radRichTextBox1.InsertImage(openDialog.OpenFile(), extension);
                }
