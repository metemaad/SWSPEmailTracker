...
namespace SWSPET.BL.SWSPET.Control
{
    public partial class Editor : UserControl, SearchableBrowser
    {
        ...
        {
            get { return null; } //webBrowser1.Document; }
        }
        ...
        public string DocumentText
        {
            get
            {
                return  null;//webBrowser1.DocumentText;
            }
            set
            {
        ...
        public string DocumentTitle
        {
            get
            {
                return null;//webBrowser1.DocumentTitle;
            }
        }
        ...
        public string BodyHtml
        {
            get
            {
              //  if (//webBrowser1.Document != null &&
                    //webBrowser1.Document.Body != null)
                {
                    return null;//webBrowser1.Document.Body.InnerHtml;
                }
                //else
                  //  return string.Empty;
            }
        ...
        public string BodyText
        {
            get
            {
               // if (//webBrowser1.Document != null &&
                    //webBrowser1.Document.Body != null)
                {
                    return null;//webBrowser1.Document.Body.InnerText;
                }
                //else
                  //  return string.Empty;
            }
        ...
        public void Bold()
        {
            ...
            //radRichTextBox1.Document.Selection.
        }
        ...
        public FontSize FontSize
        {
            get
            {
                if (ReadyState != ReadyState.Complete)
                    return FontSize.NA;
                string s = doc.queryCommandValue("FontSize").ToString();
                switch (s)
                {
                    case "1":
                        return FontSize.One;
        ...
        private void changecurrent()
        {
            ...
            var a = new StyleDefinition();
            
            //this.boldButton.Checked = radRichTextBox1.ChangeSpanStyle(new StyleDefinition({ }))
        }
